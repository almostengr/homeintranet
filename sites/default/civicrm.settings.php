...
if (!defined('CIVICRM_UF_DSN')) {
  define( 'CIVICRM_UF_DSN'           , 'mysql://aphintranet:ozqkxA50OMDY17hq7FU0@localhost/phintranet?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  define( 'CIVICRM_DSN'          , 'mysql://aphintranet:ozqkxA50OMDY17hq7FU0@localhost/phintranet?new_link=true');
}
...
$civicrm_root = '/var/www/intranet.matrixneo.ddns.net/drupal/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/var/www/intranet.matrixneo.ddns.net/drupal/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://drifttt/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '96e8975c32e836bdd3d760b483c38474');
}
...
// define( 'CIVICRM_MAIL_LOG', '/var/www/intranet.matrixneo.ddns.net/drupal/sites/default/files/civicrm/templates_c//mail.log');
// }
